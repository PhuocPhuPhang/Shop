...
<div class="row">
        ...
        <div class="x_panel">
            <div class="x_title">
            <h2>Sữa</h2><small>{{$khuyenmai->ten_khuyen_mai}}</small>
            <div class="clearfix"></div>
            </div>
            <div class="x_content">
            ...
            <form id="demo-form" action="../sua/{{$khuyenmai->id}}" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
