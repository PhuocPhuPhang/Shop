...
<div class="col-md-3 left_col menu_fixed">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="{{url('Shop/admin/index')}}" class="site_title"><i class="fa fa-paw"></i> <span>Shop</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                <ul class="nav side-menu">
                    <li><a href="{{url('shop/admin/index')}}"><i class="fa fa-home"></i>Trang chủ</a></li>
                    <li><a href="{{url('shop/admin/nhacungcap/danhsach')}}"><i class="fa fa-industry"></i>Nhà Cung Cấp</a></li>

                    <li><a><i class="fa fa-newspaper-o"></i>Bài Viết<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{url('shop/admin/tintuc/gioithieu')}}">Giới thiệu</a></li>
                            <li><a href="{{url('shop/admin/tintuc/danhsach')}}">Tin Tức</a></li>
                            <li><a href="{{url('shop/admin/tintuc/chinhsach')}}">Chính sách</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a><i class="fa fa-user"></i>Users<span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{url('shop/admin/user/khachhang')}}">Khách hàng</a></li>
                            <li><a href="{{url('shop/admin/user/nhanvien')}}">Nhân viên</a></li>
                        </ul>
                    </li>
                    <li><a href="{{url('shop/admin/website/thongtin')}}"><i class="fa fa-cogs"></i>Cấu hình website</a></li>
                    @endif
