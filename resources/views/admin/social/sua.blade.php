...
<div class="row">
        ...
        <div class="x_panel">
            ...
            <form id="demo-form" action="admin/social/sua/{{$social->id}}" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
